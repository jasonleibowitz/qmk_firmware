 ...
 * |-----------------------------------------------------------------------------------------+
 * | Ctrl |  Alt  |  Cmd  |   Spc   |  Bkspc   |      Spc     | Cmd | RAlt |  L  |  D  |  R  |
 * `-----------------------------------------------------------------------------------------'
 */
  ...
  KEYMAP_2_SHIFTS(
      ...
      KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_BSPC, KC_SPC, KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT
      ),
 ...
 */
  ...
  KEYMAP_DIRECTIONAL(
      ...
      ______, RGB_MOD, ______, ______, ______, ______, ______, ______, KC_UP, ______, ______, RGB_VAI, RGB_VAD, RGB_TOG,
      ______, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, ______, ______, KC_LEFT, KC_DOWN, KC_RIGHT, ______, ______,
