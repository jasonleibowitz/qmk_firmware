...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_DL] = KEYMAP_2_SHIFTS(
		...
		LT(1, KC_ESC),             KC_A,     KC_S,  KC_D,     KC_F,  KC_G,    KC_H,    KC_J,    KC_K,     KC_L, KC_SCLN, KC_QUOT,  KC_ENT,
		      ...
		      KC_LCTL, KC_LALT, KC_LGUI,  KC_BSPC, MO(2), KC_SPACE, MO(1), KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT),
vvvvvvvvvvvvvv
	[_UTIL] = KEYMAP_2_SHIFTS(
		KC_GRAVE, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______,  KC_DEL,
	...
	[_LIGHTS] = KEYMAP_2_SHIFTS(
		_______, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_P, _______, _______, _______, _______, _______, _______,
		...
		_______, RGB_HUI, RGB_HUD,  RGB_SAI,  RGB_SAD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
